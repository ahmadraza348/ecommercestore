                                    ...
                                    <div class="featured-carousel-active2 row arrow-space slick-arrow-style" data-row="2">
                                            ...
                                            <div class="product-item fix mb-30">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend/assets/img/product/product-s-1.jpg') }}"
                                                            class="img-pri" alt="">
                                                        <img src="{{ asset('frontend/assets/img/product/product-s-2.jpg') }}"
                                                            class="img-sec" alt="">
                                                    </a>
                                        ...
                                        <div class="col">
                                            <div class="product-item fix mb-30">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend/assets/img/product/product-s-3.jpg') }}"
                                                            class="img-pri" alt="">
                                                        <img src="{{ asset('frontend/assets/img/product/product-s-4.jpg') }}"
                                                            class="img-sec" alt="">
                                                    </a>
                                                    <div class="product-label">
                                                        <span>hot</span>
                                        ...
                                        <div class="col">
                                            <div class="product-item fix mb-30">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend/assets/img/product/product-s-5.jpg') }}"
                                                            class="img-pri" alt="">
                                                        <img src="{{ asset('frontend/assets/img/product/product-s-6.jpg') }}"
                                                            class="img-sec" alt="">
                                                    </a>
                                                    <div class="product-label">
                                                        <span>hot</span>
                                        ...
                                        <div class="col">
                                            <div class="product-item fix mb-30">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend/assets/img/product/product-f-1.jpg') }}"
                                                            class="img-pri" alt="">
                                                        <img src="{{ asset('frontend/assets/img/product/product-f-2.jpg') }}"
                                                            class="img-sec" alt="">
                                                    </a>
                                                    <div class="product-label">
                                                        <span>hot</span>
                                        ...
                                        <div class="col">
                                            <div class="product-item fix mb-30">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend/assets/img/product/product-f-3.jpg') }}"
                                                            class="img-pri" alt="">
                                                        <img src="{{ asset('frontend/assets/img/product/product-f-4.jpg') }}"
                                                            class="img-sec" alt="">
                                                    </a>
                                                    <div class="product-label">
                                                        <span>hot</span>
                                        ...
                                        <div class="col">
                                            <div class="product-item fix mb-30">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend/assets/img/product/product-b-1.jpg') }}"
                                                            class="img-pri" alt="">
                                                        <img src="{{ asset('frontend/assets/img/product/product-b-2.jpg') }}"
                                                            class="img-sec" alt="">
                                                    </a>
                                                    <div class="product-label">
                                                        <span>hot</span>
                                        ...
                                        <div class="col">
                                            <div class="product-item fix mb-30">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend/assets/img/product/product-b-3.jpg') }}"
                                                            class="img-pri" alt="">
                                                        <img src="{{ asset('frontend/assets/img/product/product-b-4.jpg') }}"
                                                            class="img-sec" alt="">
                                                    </a>
                                                    <div class="product-label">
                                                        <span>hot</span>
            ...
            <div class="row">
                        ...
                        <div class="main-sidebar hot-deals-wrap mb-30">
                            ...
                            <div class="deals-carousel-active slick-padding slick-arrow-style">
                                ...
                                <div class="product-item fix">
                                    <div class="product-thumb">
                                        <a href="product-details.html">
                                            <img src="{{ asset('frontend/assets/img/product/product-img7.jpg') }}"
                                                class="img-pri" alt="">
                                            <img src="{{ asset('frontend/assets/img/product/product-img13.jpg') }}"
                                                class="img-sec" alt="">
                                        </a>
                                        <div class="product-label">
                                            <span>hot</span>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="feature-category-area mt-md-70">
                        ...
                        <div class="featured-carousel-active slick-padding slick-arrow-style">
                            ...
                            <div class="product-item fix">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="{{ asset('frontend/assets/img/product/product-img7.jpg') }}"
                                            class="img-pri" alt="">
                                        <img src="{{ asset('frontend/assets/img/product/product-img8.jpg') }}"
                                            class="img-sec" alt="">
                                    </a>
                                    <div class="product-label">
                                        <span>hot</span>
                            ...
                            <div class="product-item fix">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="{{ asset('frontend/assets/img/product/product-img9.jpg') }}"
                                            class="img-pri" alt="">
                                        <img src="{{ asset('frontend/assets/img/product/product-img10.jpg') }}"
                                            class="img-sec" alt="">
                                    </a>
                            ...
                            <div class="product-item fix">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="{{ asset('frontend/assets/img/product/product-img11.jpg') }}"
                                            class="img-pri" alt="">
                                        <img src="{{ asset('frontend/assets/img/product/product-img12.jpg') }}"
                                            class="img-sec" alt="">
                                    </a>
                    ...
                    <div class="banner-statistic pt-28 pb-36">
                        <div class="img-container fix img-full">
                            <a href="#">
                                <img src="{{ asset('frontend/assets/img/banner/banner_static1.jpg') }}"
                                    alt="">
                            </a>
                        </div>
                    </div>
                                    ...
                                    <div class="hot-deals-wrap3 mb-30 mb-md-36 mb-sm-22 mt-xs-28">
                                        ...
                                        <div class="deals-carousel-active2 slick-padding slick-arrow-style">
                                            ...
                                            <div class="product-item fix">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{asset('frontend/assets/img/product/product-f-1.jpg')}}" class="img-pri" alt="">
                                                        <img src="{{asset('frontend/assets/img/product/product-f-2.jpg')}}" class="img-sec" alt="">
                                                    </a>
                                                    <div class="product-label">
                                                        <span>hot</span>
                                                    </div>
                                            ...
                                            <div class="product-item fix">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{asset('frontend/assets/img/product/product-f-3.jpg')}}" class="img-pri" alt="">
                                                        <img src="{{asset('frontend/assets/img/product/product-f-4.jpg')}}" class="img-sec" alt="">
                                                    </a>
                                                    <div class="product-label">
                                                        <span>hot</span>
                                                    </div>
                                            ...
                                            <div class="product-item fix">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{asset('frontend/assets/img/product/product-f-2.jpg')}}" class="img-pri" alt="">
                                                        <img src="{{asset('frontend/assets/img/product/product-f-1.jpg')}}" class="img-sec" alt="">
                                                    </a>
                                                    <div class="product-label">
                                                        <span>hot</span>
                                                    </div>
                                    ...
                                    <div class="hot-deals-wrap3 mb-30 mb-md-22 mb-sm-22 mt-sm-14">
                                        ...
                                        <div class="deals-carousel-active2 slick-padding slick-arrow-style">
                                            ...
                                            <div class="product-item fix">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{asset('frontend/assets/img/product/product-s-5.jpg')}}" class="img-pri" alt="">
                                                        <img src="{{asset('frontend/assets/img/product/product-s-6.jpg')}}" class="img-sec" alt="">
                                                    </a>
                                                    <div class="product-label">
                                                        <span>hot</span>
                                                    </div>
                                            ...
                                            <div class="product-item fix">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{asset('frontend/assets/img/product/product-s-3.jpg')}}" class="img-pri" alt="">
                                                        <img src="{{asset('frontend/assets/img/product/product-s-4.jpg')}}" class="img-sec" alt="">
                                                    </a>
                                                    <div class="product-label">
                                                        <span>hot</span>
                                                    </div>
                                            ...
                                            <div class="product-item fix">
                                                <div class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{asset('frontend/assets/img/product/product-s-1.jpg')}}" class="img-pri" alt="">
                                                        <img src="{{asset('frontend/assets/img/product/product-s-2.jpg')}}" class="img-sec" alt="">
                                                    </a>
                                                    <div class="product-label">
                                                        <span>hot</span>
                                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-7">
                                <div class="img-container fix img-full mb-sm-30">
                                    <a href="#">
                                        <img src="{{ asset('frontend/assets/img/banner/banner_static2.jpg') }}"
                                            alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-5 col-md-5">
                                <div class="img-container fix img-full mb-sm-30">
                                    <a href="#">
                                        <img src="{{ asset('frontend/assets/img/banner/banner_static3.jpg') }}"
                                            alt="">
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="category-carousel-active row" data-row="4">
                                        ...
                                        <div class="col">
                                            <div class="category-item">
                                                <div class="category-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend/assets/img/product/product-img15.jpg') }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="category-content">
                                        ...
                                        <div class="col">
                                            <div class="category-item">
                                                <div class="category-thumb">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend/assets/img/product/product-img16.jpg') }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="category-content">
        ...
        <div class="container">
            ...
            <div class="latest-product-active slick-padding slick-arrow-style">
                ...
                <div class="product-item fix">
                    <div class="product-thumb">
                        <a href="product-details.html">
                            <img src="{{ asset('frontend/assets/img/product/product-img1.jpg') }}" class="img-pri"
                                alt="">
                            <img src="{{ asset('frontend/assets/img/product/product-img2.jpg') }}" class="img-sec"
                                alt="">
                        </a>
                        <div class="product-label">
                            <span>hot</span>
                ...
                <div class="product-item fix">
                    <div class="product-thumb">
                        <a href="product-details.html">
                            <img src="{{ asset('frontend/assets/img/product/product-img3.jpg') }}" class="img-pri"
                                alt="">
                            <img src="{{ asset('frontend/assets/img/product/product-img4.jpg') }}" class="img-sec"
                                alt="">
                        </a>
                        <div class="product-label">
                            <span>hot</span>
                ...
                <div class="product-item fix">
                    <div class="product-thumb">
                        <a href="product-details.html">
                            <img src="{{ asset('frontend/assets/img/product/product-img5.jpg') }}" class="img-pri"
                                alt="">
                            <img src="{{ asset('frontend/assets/img/product/product-img6.jpg') }}" class="img-sec"
                                alt="">
                        </a>
                        <div class="product-label">
                            <span>hot</span>
                ...
                <div class="product-item fix">
                    <div class="product-thumb">
                        <a href="product-details.html">
                            <img src="{{ asset('frontend/assets/img/product/product-img7.jpg') }}" class="img-pri"
                                alt="">
                            <img src="{{ asset('frontend/assets/img/product/product-img8.jpg') }}" class="img-sec"
                                alt="">
                        </a>
                        <div class="product-label">
                            <span>hot</span>
                ...
                <div class="product-item fix">
                    <div class="product-thumb">
                        <a href="product-details.html">
                            <img src="{{ asset('frontend/assets/img/product/product-img9.jpg') }}" class="img-pri"
                                alt="">
                            <img src="{{ asset('frontend/assets/img/product/product-img10.jpg') }}" class="img-sec"
                                alt="">
                        </a>
                        <div class="product-label">
                            <span>hot</span>
                ...
                <div class="product-item fix">
                    <div class="product-thumb">
                        <a href="product-details.html">
                            <img src="{{ asset('frontend/assets/img/product/product-img11.jpg') }}" class="img-pri"
                                alt="">
                            <img src="{{ asset('frontend/assets/img/product/product-img12.jpg') }}" class="img-sec"
                                alt="">
                        </a>
                        <div class="product-label">
                            <span>hot</span>
