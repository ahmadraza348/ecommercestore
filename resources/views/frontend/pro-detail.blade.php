                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="product-details-des mt-md-34 mt-sm-34">
                                        ...
                                        <select name="" id=""class="form-control mt-20">
                                            @foreach($product->colors as $item)
                                            <option value="">{{$item->color->name}}</option>
                                            @endforeach
                                        </select>
                                            ...
                                            <div class="tab-pane fade show active" id="tab_one">
                                                <div class="tab-one">
                                                    ...
                                                    <div class="review-description">
                                                        <div class="tab-thumb">
                                                            <img src="frontend/assets/img/about/services.jpg')}}" alt="">
                                                        </div>
                        ...
                        <div class="shop-sidebar-wrap fix mt-md-22 mt-sm-22">
                            ...
                            <div class="sidebar-widget mb-22">
                                <div class="img-container fix img-full mt-30">
                                    <a href="#"><img src="frontend/assets/img/banner/banner_shop.jpg')}}" alt=""></a>
                                </div>
                            </div>
                            <!-- sidebar banner end -->
                        </div>
