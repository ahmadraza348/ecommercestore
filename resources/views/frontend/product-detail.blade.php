                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="pro-nav slick-padding2 slick-arrow-style_2">
                                <div class="pro-nav-thumb"><img src="{{asset('frontend/assets/img/product/product-details-img1.jpg')}}" alt="" /></div>
                                <div class="pro-nav-thumb"><img src="{{asset('frontend/assets/img/product/product-details-img2.jpg')}}" alt="" /></div>
                                <div class="pro-nav-thumb"><img src="{{asset('frontend/assets/img/product/product-details-img3.jpg')}}" alt="" /></div>
                                <div class="pro-nav-thumb"><img src="{{asset('frontend/assets/img/product/product-details-img4.jpg')}}" alt="" /></div>
                                <div class="pro-nav-thumb"><img src="{{asset('frontend/assets/img/product/product-details-img2.jpg')}}" alt="" /></div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                    ...
                                    <div class="tab-pane fade show active" id="tab_one">
                                        <div class="tab-one">
                                            ...
                                            <div class="review-description">
                                                <div class="tab-thumb">
                                                    <img src="{{asset('frontend/assets/img/about/services.jpg')}}" alt="">
                                                </div>
