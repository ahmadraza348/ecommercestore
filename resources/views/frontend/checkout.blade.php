                    ...
                    <div class="checkoutaccordion" id="checkOutAccordion">
                        <div class="card">
                            ...
                            <div id="logInaccordion" class="collapse" data-parent="#checkOutAccordion">
                                <div class="card-body">
                                    <p class="my-3">If you have shopped with us before, please enter your details in the
                                ...
                                <form action="#">
                                    ...
                                    <div class="single-input-item mb-3">
                                        ...
                                        <input type="text" id="billing_company" name="billing[company]"
                                            value="{{ old('billing.company') }}" placeholder="Company Name" />
                                    </div>
                                    ...
                                    <div class="single-input-item mb-3">
                                        ...
                                        <select name="billing[country]" id="billing_country" class="form-select" required>
                                            ...
                                            <option value="Afghanistan"
                                                {{ old('billing.country') == 'Afghanistan' ? 'selected' : '' }}>Afghanistan
                                            </option>
                                            <option value="Bangladesh"
                                                {{ old('billing.country') == 'Bangladesh' ? 'selected' : '' }}>Bangladesh
                                            </option>
                                            <option value="India"
                                                {{ old('billing.country') == 'India' ? 'selected' : '' }}>India</option>
                                            <option value="Pakistan"
                                                {{ old('billing.country') == 'Pakistan' ? 'selected' : '' }}>Pakistan
                                            </option>
                                            <option value="England"
                                                {{ old('billing.country') == 'England' ? 'selected' : '' }}>England
                                            </option>
                                        </select>
                                    ...
                                    <div class="single-input-item mb-3">
                                        ...
                                        <input type="text" id="billing_address_1" name="billing[address_1]"
                                            value="{{ old('billing.address_1') }}" placeholder="Street address Line 1"
                                            required />
                                    ...
                                    <div class="single-input-item mb-3">
                                        ...
                                        <input type="text" id="billing_city" name="billing[city]"
                                            value="{{ old('billing.city') }}" placeholder="Town / City" required />
                                        @error('billing.city')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="checkout-box-wrap mb-4">
                                        <div class="single-input-item">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="ship_to_different"
                                                    name="different_shipping" value="1">
                                                <label class="form-check-label" for="ship_to_different">Ship to a
                                        ...
                                        <div class="ship-to-different single-form-row">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="single-input-item mb-3">
                                                        <label for="shipping_first_name" class="required">First
                                                            Name</label>
                                            ...
                                            <div class="single-input-item mb-3">
                                                ...
                                                <input type="email" id="shipping_email" name="shipping[email]"
                                                    value="{{ old('shipping.email') }}" placeholder="Email Address" />
                                            ...
                                            <div class="single-input-item mb-3">
                                                ...
                                                <input type="text" id="shipping_company" name="shipping[company]"
                                                    value="{{ old('shipping.company') }}" placeholder="Company Name" />
                                            </div>
                                            ...
                                            <div class="single-input-item mb-3">
                                                ...
                                                <select name="shipping[country]" id="shipping_country"
                                                    ...
                                                    <option value="">Select Country</option>
                                                    <option value="Bangladesh"
                                                        {{ old('shipping.country') == 'Bangladesh' ? 'selected' : '' }}>
                                                        Bangladesh</option>
                                                    <option value="India"
                                                        {{ old('shipping.country') == 'India' ? 'selected' : '' }}>India
                                                    </option>
                                                    <option value="Pakistan"
                                                        {{ old('shipping.country') == 'Pakistan' ? 'selected' : '' }}>
                                                        Pakistan</option>
                                                    <option value="England"
                                                        {{ old('shipping.country') == 'England' ? 'selected' : '' }}>
                                                        England</option>
                                                </select>
                                            ...
                                            <div class="single-input-item mb-3">
                                                <label for="shipping_address_1" class="required pt-20">Street
                                                    address</label>
                                            ...
                                            <div class="single-input-item mb-3">
                                                ...
                                                <input type="text" id="shipping_city" name="shipping[city]"
                                                    value="{{ old('shipping.city') }}" placeholder="Town / City" />
                                                @error('shipping.city')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="single-input-item mb-3">
                                                ...
                                                <input type="text" id="shipping_state" name="shipping[state]"
                                                    value="{{ old('shipping.state') }}" placeholder="State / Division" />
                                            </div>
                            ...
                            <div class="order-summary-content mb-sm-4">
                                        ...
                                        <tbody>
                                            @if ($cartData && $cartData->items->count() > 0)
                                                @foreach ($cartData->items as $item)
                                                    <tr>
                                                        <td><a href="{{ route('pro.details', $item->product->slug) }}">{{ $item->product_name }}
                                ...
                                <div class="order-payment-method">
                                    ...
                                    <div class="single-payment-method">
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="cardPayment" name="payment_method"
                                                    value="stripe" class="custom-control-input" />
                                                <label class="custom-control-label" for="cardPayment">Card Payment <img
