        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="dash-widget">
                    <div class="dash-widgetimg">
                        <span><img src="{{ asset('backend/assets/img/icons/dash1.svg') }}"
                                alt="img"></span>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="dash-widget dash1">
                    <div class="dash-widgetimg">
                        <span><img src="{{ asset('backend/assets/img/icons/dash2.svg') }}"
                                alt="img"></span>
                    </div>
                    <div class="dash-widgetcontent">
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="dash-widget dash2">
                    <div class="dash-widgetimg">
                        <span><img src="{{ asset('backend/assets/img/icons/dash3.svg') }}"
                                alt="img"></span>
                    </div>
                    <div class="dash-widgetcontent">
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="dash-widget dash3">
                    <div class="dash-widgetimg">
                        <span><img src="{{ asset('backend/assets/img/icons/dash4.svg') }}"
                                alt="img"></span>
                    </div>
                    <div class="dash-widgetcontent">
                        ...
                        <div class="graph-sets">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-white btn-sm dropdown-toggle" type="button"
                                    ...
                                    2022 <img src="{{ asset('backend/assets/img/icons/dropdown.svg') }}"
                                        alt="img" class="ms-2">
                                </button>
