                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="itemcode[]"
                                                                value="{{ $itemcode }}" required class="form-control"
                                                                readonly />
                                                        </td>
                                                                ...
                                                                <select
                                                                    ...
                                                                    @foreach ($attribute->attributevalue as $value)
                                                                        <option value="{{ $value->id }}"
                                                                            {{ $attributeGroup->where('pivot.attribute_id', $attribute->id)->pluck('pivot.attribute_value_id')->contains($value->id)? 'selected': '' }}>
                                                                            {{ $value->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
