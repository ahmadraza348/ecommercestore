                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-sales-split">
                            ...
                            <ul>                                
                                <li>
                                    <a href="javascript:void(0);"><img src="{{asset('backend/assets/img/icons/pdf.svg')}}" alt="img"></a>
                                </li>                                
                                <li>
                                    <a href="javascript:void(0);"><img src="{{asset('backend/assets/img/icons/printer.svg')}}" alt="img"></a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <font style="vertical-align: inherit;">
                                                                <font
                                                                  ...
                                                                  Name:   {{ $order->billing_first_name }} {{ $order->billing_last_name }}</font>
                                                            </font><br>
                                                        ...
                                                        <td
                                                            ...
                                                            <font style="vertical-align: ginherit;">
                                                                <font
                                                                    style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                                                  Name:   {{ $order->shipping_first_name }} {{ $order->shipping_last_name }}</font>
                                                            </font><br>
                                    ...
                                    <tr class="details" style="border-bottom:1px solid #E9ECEF ;">
                                        <td
                                            ...
                                            <img src="{{asset('backend/assets/img/product/product1.jpg')}}" alt="img" class="me-2"
